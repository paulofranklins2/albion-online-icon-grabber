...
public class APICrawlerGather {
    private static final String URL = "https://render.albiononline.com/v1/item/";
    private static final String TYPE_NAMES_FILE = "src/main/resources/gather_names.txt";
    private static final String DOWNLOADED_FILE = "src/main/resources/gather_downloaded.txt";
    private static final String DOWNLOAD_DIR = "src/main/resources/gatherdownload";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Error reading gather_names.txt file: " + e.getMessage());
            return;
        }
        ...
        for (String name : names) {
            for (int enchantment = 0; enchantment <= 4; enchantment++) {
                ...
                for (int quality = 1; quality <= 5; quality++) {
                    String qualityLabel = QUALITY_LABELS.get(quality);

                    for (int tier = 4; tier <= 8; tier++) {
                        String imageUrl = URL + "T" + tier + "_" + name + enchantmentLabel + ".png?quality=" + quality;
                        String fileName = "T" + tier + "_" + name + enchantmentLabel + qualityLabel + ".png";
